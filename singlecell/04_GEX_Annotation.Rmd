...
# PNG
ggsave(file.path(script_output_dir, "plots/umap_markers_d3.png"), plot = d3_grid,
...
# PNG
ggsave(file.path(script_output_dir, "plots/umap_markers_d15.png"), plot = d15_grid,
     dpi = 300, width = 10, height = 6, device = "png")
```
...
```{r}
# PNG
ggsave(file.path(script_output_dir, "plots/umap_markers_immune_d3.png"), plot = d3_grid_imm,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/umap_markers_immune_d15.png"), plot = d15_grid_imm,
     dpi = 300, width = 6, height = 6, device = "png")
```
...
# QC PDF
cairo_pdf(file=file.path(script_output_dir, "plots/qc_annotation.pdf"), 
