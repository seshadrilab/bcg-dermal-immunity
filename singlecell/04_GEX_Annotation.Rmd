...
if (save_output) {
  # PNG
  ggsave(file.path(script_output_dir, "out/umap_markers_d3.png"), plot = d3_grid,
       dpi = 300, width = 10, height = 6, device = "png")
  # SVG
  ggsave(file.path(script_output_dir, "out/umap_markers_d3.svg"), plot = d3_grid,
       dpi = 300, width = 10, height = 6, device = "svg")
}
```
...
if (save_output) {
  # PNG
  ggsave(file.path(script_output_dir, "out/umap_markers_d15.png"), plot = d15_grid,
       dpi = 300, width = 10, height = 6, device = "png")
  # SVG
  ggsave(file.path(script_output_dir, "out/umap_markers_d15.svg"), plot = d15_grid,
       dpi = 300, width = 10, height = 6, device = "svg")
}
```
...
if (save_output) {
  # PNG
  ggsave(file.path(script_output_dir, "out/umap_markers_immune_d3.png"), plot = d3_grid_imm,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/umap_markers_immune_d15.png"), plot = d15_grid_imm,
       dpi = 300, width = 6, height = 6, device = "png")

  # SVG
  ggsave(file.path(script_output_dir, "out/umap_markers_immune_d3.svg"), plot = d3_grid_imm,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/umap_markers_immune_d15.svg"), plot = d15_grid_imm,
       dpi = 300, width = 6, height = 6, device = "svg")
}
```
...
# QC PDF
if (save_output) {
    cairo_pdf(file=file.path(script_output_dir, "out/qc_annotation.pdf"), 
