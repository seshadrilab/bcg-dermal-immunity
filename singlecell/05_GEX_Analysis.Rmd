...
The goal is to tie this data together with findings from some of the other datasets:
...
Define new annotations to match CyTOF cell types as best we can. I don't feel like I can confidently label "cytotoxic" T cells.

```{r}
# Make CyTOF-related annotations that include non-immune cells

# For now don't worry about cytotoxic T cells (how would I define those?)
...
ggsave(file.path(script_output_dir, "out/Fig5_boxplots.png"), plot = composition_grid,
       dpi = 300, width = 3, height = 4.5, device = "png")

cairo_pdf(file = file.path(script_output_dir, "out/Fig5_boxplots.pdf"), 
...
# TODO: Try projecting GEX data onto protein-protein interaction network and see if interactions look different
```
...
# Save
cairo_pdf(file = file.path(script_output_dir, "out/d3_cellchat.pdf"), 
          width=5, height=5,
...
# Save
cairo_pdf(file = file.path(script_output_dir, "out/d15_cellchat.pdf"), 
          width=5, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial")
...
pop_levels_d3 <- c("T cells", "MAIT cells", "Tcm", "B cells", "Lymphoid other", "Monocytes", "Myeloid other")
pop_levels_d15 <- c("T cells", "MAIT cells", "Tcm", "B cells", "Lymphoid other", "Monocytes", "Myeloid other", "Granulocytes")
...
# Save
ggsave(file.path(script_output_dir, "out/Fig5_violin.png"), plot = grid_vln,
       dpi = 300, width = 3.5, height = 5, device = "png")

cairo_pdf(file = file.path(script_output_dir, "out/Fig5_violin.pdf"), 
