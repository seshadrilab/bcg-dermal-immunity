...
# Save all output, instead of just minimum required objects for the next scripts
save_output <- TRUE

# Top-level folder where script outputs should be stored
script_output_dir <- "~/workspace/bcg_challenge_out_inh"
...
if (save_output) {
  # Dots
  cairo_pdf(file=file.path(script_output_dir, "out/qc_scdblfinder.pdf"), width=5, height=5,
...
if (save_output) {
  # Day 3
  ggsave(file.path(script_output_dir, "out/SuppFig4_qc_barplot_d3.png"), plot = d3qc_plot,
         dpi = 300, width = 4, height = 2, device = "png")

  cairo_pdf(file = file.path(script_output_dir, "out/SuppFig4_qc_barplot_d3.pdf"), 
            width=4, height=2, bg = "transparent", family = "Arial")
  print(d3qc_plot)
  dev.off()
  
  # Day 15
  ggsave(file.path(script_output_dir, "out/SuppFig4_qc_barplot_d15.png"), plot = d15qc_plot,
         dpi = 300, width = 4, height = 2, device = "png")

  cairo_pdf(file = file.path(script_output_dir, "out/SuppFig4_qc_barplot_d15.pdf"), 
            width=4, height=2, bg = "transparent", family = "Arial")
  print(d15qc_plot)
  dev.off()
}
...
if (save_output) {
  # Dotplots Day 3
  ggsave(file.path(script_output_dir, "out/SuppFig4_d3dot.png"), plot = d3dot,
       dpi = 300, width = 3, height = 4.5, device = "png")

  cairo_pdf(file = file.path(script_output_dir, "out/SuppFig4_d3dot.pdf"), 
            width=3, height=4.5, bg = "transparent", family = "Arial")
  print(d3dot)
  dev.off()

  # Dotplots Day 15
  ggsave(file.path(script_output_dir, "out/SuppFig4_d15dot.png"), plot = d15dot,
       dpi = 300, width = 3, height = 4.5, device = "png")

  cairo_pdf(file = file.path(script_output_dir, "out/SuppFig4_d15dot.pdf"), 
            width=3, height=4.5, bg = "transparent", family = "Arial")
  print(d15dot)
  dev.off()
  
  # Legend
  ggsave(file.path(script_output_dir, "out/SuppFig4_legend.png"), plot = forleg,
     dpi = 300, width = 3, height = 4.5, device = "png")

  cairo_pdf(file = file.path(script_output_dir, "out/SuppFig4_legend.pdf"), 
            width=3, height=4.5, bg = "transparent", family = "Arial")
  print(forleg)
  dev.off()
}
...
# Plots
if (save_output) {
    cairo_pdf(file=file.path(script_output_dir, "out/qc_clustering_d3.pdf"), 
              width=11, height=8.5, onefile = TRUE, bg = "transparent", family = "Arial") 
  print(p1)
  print(v1)
  print(v2)
  print(h1)
  ...
  # PNG
  ggsave(file.path(script_output_dir, "out/umap_d3_seurat.png"), plot = p1,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/umap_d3_ptid.png"), plot = p2,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/umap_d3_arm.png"), plot = p3,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/legend_arm.png"), plot = arm_legend,
       dpi = 300, width = 2, height = 1, device = "png")
  

  # SVG
  ggsave(file.path(script_output_dir, "out/umap_d3_seurat.svg"), plot = p1,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/umap_d3_ptid.svg"), plot = p2,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/umap_d3_arm.svg"), plot = p3,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/legend_arm.svg"), plot = arm_legend,
       dpi = 300, width = 2, height = 1, device = "svg")
}
```
...
# Plots
if (save_output) {
    cairo_pdf(file=file.path(script_output_dir, "out/qc_clustering_d15.pdf"), 
              width=11, height=8.5, onefile = TRUE, bg = "transparent", family = "Arial") 
  print(p11)
  print(v11)
  print(v12)
  ...
  # PNG
  ggsave(file.path(script_output_dir, "out/umap_d15_seurat.png"), plot = p11,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/umap_d15_ptid.png"), plot = p12,
       dpi = 300, width = 6, height = 6, device = "png")
  ggsave(file.path(script_output_dir, "out/umap_d15_arm.png"), plot = p13,
       dpi = 300, width = 6, height = 6, device = "png")

  # SVG
  ggsave(file.path(script_output_dir, "out/umap_d15_seurat.svg"), plot = p11,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/umap_d15_ptid.svg"), plot = p12,
       dpi = 300, width = 6, height = 6, device = "svg")
  ggsave(file.path(script_output_dir, "out/umap_d15_arm.svg"), plot = p13,
       dpi = 300, width = 6, height = 6, device = "svg")
}
```
