...
```{r}
# Dots
cairo_pdf(file=file.path(script_output_dir, "plots/qc_scdblfinder.pdf"), width=5, height=5,
...
# Plots
cairo_pdf(file=file.path(script_output_dir, "plots/qc_clustering_d3.pdf"), 
...
# PNG
ggsave(file.path(script_output_dir, "plots/umap_d3_seurat.png"), plot = p1,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/umap_d3_ptid.png"), plot = p2,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/umap_d3_arm.png"), plot = p3,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/legend_arm.png"), plot = arm_legend,
...
# Plots
cairo_pdf(file=file.path(script_output_dir, "plots/qc_clustering_d15.pdf"), 
            width=11, height=8.5, onefile = TRUE, bg = "transparent", family = "Arial") 
print(p11)
print(v11)
print(v12)
...
# PNG
ggsave(file.path(script_output_dir, "plots/umap_d15_seurat.png"), plot = p11,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/umap_d15_ptid.png"), plot = p12,
     dpi = 300, width = 6, height = 6, device = "png")
ggsave(file.path(script_output_dir, "plots/umap_d15_arm.png"), plot = p13,
     dpi = 300, width = 6, height = 6, device = "png")
```
