...
*File creation: February, 13th 2024*  
...
```
```{r echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
# load(here("output", "002_output", "002_EDA-COMPASS_CD8+T.RData"))
# save.image(here("output", "002_output", "002_EDA-COMPASS_CD8+T.RData"))
```
...
`COMPASS` with CD8+ T expressing 1 of 7 cytokines or functional activation markers (IFN-$\gamma$, TNF-$\alpha$, CD154, CD153, GM-CSF, IL-2, IL-17a and IL-4/IL-13) has been run on Rhino; see code below:  

* `002A_COMPASScontainer_CD8+T.R` (1);  

* `002B_COMPASS_tuning-params_CD8+T.R` (2);  

* `002C_COMPASS_runCOMPASS_CD8+T.R` (3);  

* `002D_COMPASSMCMCDiagnosis_CD8+T.R` (4).  
...
# Models
model_files <- list.files(here("output", "002_output", "tuning", "BCG TICE"), 
                          full.names = TRUE, 
                          pattern = "CD8[+]T_negctrl_BCG TICE_tuned")
...
# Figure
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-correlation_BCG-TICE.pdf"), width = 6, height = 8, pointsize = 12)
...
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-FS_BCG-TICE.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
dt.ggplot %>%
  ...
  ggplot() +
    ...
    theme(axis.text = element_text(size = 15),
          ...
          panel.grid = element_blank(),
          legend.position = "none") -> plot
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-PFS_BCG-TICE.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
#- Figure
title <- ggdraw() + 
  draw_label("ICS: CD8+ T\nSTIM: BCG TICE",
            fontface = 'bold',
            x = 0, hjust = 0) +
  theme(plot.margin = margin(0, 0, 0, 7))
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-heatmap_BGC-TICE.pdf"), width = 8, height = 10, pointsize = 12)
...
#- Diagnostics (correlation)
# Models
model_files <- list.files(here("output", "002_output", "tuning", "Mtb 213"), 
                          full.names = TRUE, 
                          pattern = "CD8[+]T_negctrl_Mtb 213_tuned")
models <- lapply(model_files, readRDS)
# Function model_cor
model_cor <- function(x, y) 
{
...
mgcor <- t(apply(pairs, 2, function(x) model_cor(models[[x[[1]]]], models[[x[[2]]]])))
# Figure
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-correlation_Mtb213.pdf"), width = 6, height = 8, pointsize = 12)
corrplot::corrplot(mgcor)
dev.off()
```
...
dt.ggplot %>%
  ...
  ggplot() +
    ...
    theme(axis.text = element_text(size = 15),
          ...
          panel.grid = element_blank(),
          legend.position = "none") -> plot
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-FS_Mtb213.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
dt.ggplot %>%
  ...
  ggplot() +
    ...
    theme(axis.text = element_text(size = 15),
          ...
          panel.grid = element_blank(),
          legend.position = "none") -> plot
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-PFS_Mtb213.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
title <- ggdraw() + 
  draw_label("ICS: CD8+ T\nSTIM: Mtb 213",
            ...
            x = 0, hjust = 0) +
  theme(plot.margin = margin(0, 0, 0, 7))
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-heatmap_Mtb213.pdf"), width = 8, height = 10, pointsize = 12)
cowplot::plot_grid(title, 
                   heatmap_gtable, 
                   ncol = 1,
                   rel_heights = c(0.1, 1)) %>% print()
...
#- Diagnostics (correlation)
# Models
model_files <- list.files(here("output", "002_output", "tuning", "TB WCL"), 
                          full.names = TRUE, 
                          pattern = "CD8[+]T_negctrl_TB WCL_tuned")
models <- lapply(model_files, readRDS)
# Function model_cor
model_cor <- function(x, y) 
{
...
mgcor <- t(apply(pairs, 2, function(x) model_cor(models[[x[[1]]]], models[[x[[2]]]])))
# Figure
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-correlation_TB-WCL.pdf"), width = 6, height = 8, pointsize = 12)
corrplot::corrplot(mgcor)
dev.off()
```
...
dt.ggplot %>%
  ...
  ggplot() +
    ...
    theme(axis.text = element_text(size = 15),
          ...
          panel.grid = element_blank(),
          legend.position = "none") -> plot
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-FS_TB-WCL.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
dt.ggplot %>%
  ...
  ggplot() +
    ...
    theme(axis.text = element_text(size = 15),
          ...
          panel.grid = element_blank(),
          legend.position = "none") -> plot
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-PFS_TB-WCL.pdf"), width = 8, height = 7, pointsize = 12)
plot
dev.off()
```
...
title <- ggdraw() + 
  draw_label("ICS: CD8+ T\nSTIM: TB WCL",
            ...
            x = 0, hjust = 0) +
  theme(plot.margin = margin(0, 0, 0, 7))
cairo_pdf(file = here("output", "002_output", "CD8+T_COMPASS-heatmap_TB-WCL.pdf"), width = 8, height = 10, pointsize = 12)
cowplot::plot_grid(title, 
                   heatmap_gtable, 
                   ncol = 1,
                   rel_heights = c(0.1, 1)) %>% print()
...
###--- COMPASS (mean)
#- Data (BCG TICE)
res.COMPASS_1 <- readRDS(file = here("output", "002_output", "tuning", 
                                     "BCG TICE", 
                                     "CD8+T_BCG TICE_COMPASS-dx.rds"))

#- Data (Mtb 213)
res.COMPASS_2 <- readRDS(file = here("output", "002_output", "tuning", 
                                     "Mtb 213", 
                                     "CD8+T_Mtb 213_COMPASS-dx.rds"))

#- Data (TB WCL)
res.COMPASS_3 <- readRDS(file = here("output", "002_output", "tuning", 
                                     "TB WCL", 
                                     "CD8+T_TB WCL_COMPASS-dx.rds"))
...
dt.ggplot %>%
  write_csv(file = here("output", "002_output", "CD8+T_COMPASS.csv"))
dt.ggplot <- dt.ggplot %>%
  group_by(PTID, STIM) %>%
...
dt.stats %>%
  ...
  write_csv(file = here("output", "002_output", "dt-statistics_COMPASS-FS.csv"))
```
```{r eval=FALSE, echo=TRUE, message=FALSE, warnings=FALSE}
###--- COMPASS (mean)
#- Data (BCG TICE)
...
dt.stats %>%
  ...
  mutate(`FDR p-value` = p.adjust(p = `Wilcoxon signed-rank test p-value`, method = "fdr"),
         `FWER p-value` = p.adjust(p = `Wilcoxon signed-rank test p-value`, method = "bonferroni")) %>%
  write_csv(file = here("output", "002_output", "dt-statistics_COMPASS-PFS.csv"))
```
```{r eval=FALSE, echo=TRUE, message=FALSE, warnings=FALSE}
...
dt.ggplot %>%
  ggplot(aes(x = X, y = PFS)) +
    ...
    facet_wrap(~ STIM) +
    labs(x = NULL, y = "CD8+ Polyfunctionality\n(COMPASS)") +
    theme_classic() +
    theme(strip.background = element_blank(),
          strip.text = element_text(size = 16),
          axis.text = element_text(size = 12),
          axis.title = element_text(size = 16)) -> plot
cairo_pdf(filename = here("output", "003_output", "SupplFig_C_14-MAY-2024.pdf"), width = 6, height = 3, onefile = TRUE)
plot
dev.off()
```
