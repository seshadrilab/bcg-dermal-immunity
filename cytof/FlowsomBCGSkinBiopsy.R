...
# Save
ggsave(file.path(outdir, "SuppFig3_cellcount_bar.png"), plot = cellcount_bar,
       dpi = 300, width = 5, height = 3, device = "png")

cairo_pdf(file = file.path(outdir, "SuppFig3_cellcount_bar.pdf"), 
...
# Save
ggsave(file.path(outdir, "SuppFig3_nrs_boxplot.png"), plot = nrs_boxplot,
       dpi = 300, width = 7, height = 4.2, device = "png")

cairo_pdf(file = file.path(outdir, "SuppFig3_nrs_boxplot.pdf"), 
