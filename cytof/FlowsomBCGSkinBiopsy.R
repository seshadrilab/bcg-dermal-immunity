...
# Script for analyzing CyTOF data
# Author: Mohau S Makatsa
...
# Marker expression distribution
...
# UMAP visualization of CD3 expression
plotDR(sce, "UMAP", color_by = "CD3")

# UMAPs visualization of expression of multiple markers
...
# UMAP showing un-annotated clusters
plotDR(sce, "UMAP", color_by = "meta24")

# UMAP faceted by timepoint and sample
...
# UMAP visualization of manual annotations
plotDR(sce, "UMAP", color_by = "Annotations")

# Faceted by timepoint and sample
...
# Heatmap labelled by our annotations with dendrogram
plotExprHeatmap(sce, features = "type",
